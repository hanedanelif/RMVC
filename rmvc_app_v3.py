# -*- coding: utf-8 -*-
"""
RMVC Web Arayüzü v3.0 - Relational Membership Value Calculation
===============================================================
...
FARKLAR (V3 vs V2):
==================
V3 delta fonksiyonunda KRİTİK düzeltme:
- KENDİ KÜMESİ (e_i) HARİÇ tutularak hesaplama yapılır
- Bu, makaledeki Table 1 sonuçlarıyla BİREBİR eşleşir

V2'de:         E_named.items()         → Tüm kümeler dahil
V3'te:  e_j != e_i and E_named.items()  → Kendi kümesi HARIÇ

Düzeltmeler (v3.0):
1. Delta fonksiyonu: Kendi kümesi (e_i) HARİÇ tutularak hesaplanır
2. break kullanılmaz - her küme için ayrı ayrı sayılır
3. Example 1 ile doğrulandı - Table 1 ile birebir eşleşir:
   - Θ_e2(1) = 5/9 (V2'de 1/3 çıkıyordu, YANLIŞ!)  
   - Θ_e3(2) = 4/9 (V2'de 1/3 çıkıyordu, YANLIŞ!)
   - Θ_e3(5) = 4/9 (V2'de 1/3 çıkıyordu, YANLIŞ!)
   - Θ_e4(3) = 4/9 (V2'de 1/3 çıkıyordu, YANLIŞ!)
...
st.set_page_config(
    page_title="RMVC Analiz Aracı v3",
    page_icon="📊",
    layout="wide",
...
def main():
    # Başlık
    st.markdown('<div class="main-header">📊 RMVC Analiz Aracı v3</div>', unsafe_allow_html=True)
    st.markdown('<div class="sub-header">Relational Membership Value Calculation - DÜZELTİLMİŞ VERSİYON</div>', unsafe_allow_html=True)
    ...
    with st.sidebar:
        ...
        st.warning("""
        **V3 KRİTİK DÜZELTME:**
        - ✅ Delta: e_i HARİÇ diğer kümeler sayılır
        - ✅ break kaldırıldı - tüm kümeler sayılır
        - ✅ Example 1 Table 1 ile BİREBİR eşleşir
        - ⚠️ V2'den FARKLI sonuçlar verir!
        """)
